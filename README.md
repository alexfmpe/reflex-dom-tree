Reflex-dom experiment: decoupling dom layout from the actual logic by binding a whole sub-tree at once and then using the `Element er s t` at the same scope.It's basically
```haskell
